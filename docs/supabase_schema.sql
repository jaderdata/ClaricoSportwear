...
VALUES 
    ('gildan-3600-classic-academy-tee', 'Classic Academy Custom Tee', 'Academy Collection', 'Gildan 3600', 'DTF Premium', 'Ultra-durable classic crewneck shirt designed for everyday gym wear, coaching staff, and student apparel. Features vibrant high-contrast chest and back logo placements.', '100% Ring Spun Cotton • 6.0 oz/yd²', ARRAY['Black', 'White', 'Navy Blue', 'Charcoal', 'Red'], 5, 14.50, 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?auto=format&fit=crop&q=80&w=800', true),
    ('gildan-64000-softstyle-event-tee', 'Softstyle Event & Tournament Tee', 'Event Collection', 'Gildan 64000 Softstyle', 'DTF Premium', 'Lightweight, ultra-soft athletic fit ideal for event giveaways, spectator shirts, and tournament merch lines.', '100% Preshrunk Ring-Spun Cotton • 4.5 oz/yd²', ARRAY['Black', 'Sport Grey', 'Royal Blue', 'Dark Heather'], 3, 12.90, 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?auto=format&fit=crop&q=80&w=800', true),
    ('oversized-streetwear-academy-tee', 'Heavyweight Oversized Street Tee', 'Oversized', 'Gildan 3600 Heavy', 'DTF Premium', 'Modern relaxed drop-shoulder cut popular with competition teams and lifestyle sportswear collections.', '100% Heavyweight Cotton • 7.5 oz/yd²', ARRAY['Washed Black', 'Bone White', 'Olive Green'], 5, 18.00, 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?auto=format&fit=crop&q=80&w=800', true),
    ('competition-dryfit-rash-style-tee', 'Championship Performance Dry-Fit', 'Competition Shirts', 'Custom Athletic Poly', 'Sublimation / DTF', 'Moisture-wicking breathable fabric engineered for intensive mats sessions, conditioning, and tournament cornermen.', '100% Performance Polyester • 4.0 oz/yd²', ARRAY['Black/Gold', 'Navy/White', 'Red/Black'], 5, 19.50, 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?auto=format&fit=crop&q=80&w=800', false),
    ('womens-athletic-fit-softstyle-tee', 'Women''s Tailored Academy Tee', 'Women''s Collection', 'Gildan 64000L Softstyle', 'DTF Premium', 'Feminine athletic fit crafted for female BJJ practitioners, instructors, and academy members.', '100% Soft Cotton • 4.5 oz/yd²', ARRAY['Black', 'White', 'Heathers'], 4, 13.90, 'https://images.unsplash.com/photo-1503341455253-b2e723bb3dbb?auto=format&fit=crop&q=80&w=800', false),
    ('youth-jiujitsu-team-tee', 'Youth BJJ Academy Tee', 'Kids Collection', 'Gildan 5000B Heavy Cotton', 'DTF Premium', 'Durable kid-friendly material resistant to frequent washings and active mat movement.', '100% Cotton • 5.3 oz/yd²', ARRAY['Black', 'Royal Blue', 'Red'], 4, 11.50, 'https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?auto=format&fit=crop&q=80&w=800', false),
